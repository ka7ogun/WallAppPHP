			...
			<?php
				...
				switch( $dataSource ){
						...
						case "upload":
								...
								include_once("testUpload.php");
	
						   		$ins3 = "INSERT INTO Mural (name, script, landmark, artist, address, city, state, zip, country, imagePath, visible) VALUES ('$mural','$muraldescript','$land','$artist', '$muralAdd','$muralCity','$muralState', '$muralZip', '$country', 'http://localhost:8888/portfolio_2/upload/$name', '$vmural')";
